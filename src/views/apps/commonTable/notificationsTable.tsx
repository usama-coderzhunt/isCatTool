...
const DebouncedInput = ({
  ...
  return <CustomTextField label={t('notifications.search')} {...props} value={value} onChange={(e) => setValue(e.target.value)} />
}
...
const NotificationsTable: FC<NotificationsTableProps> = ({
  ...
  return (
    <div className="flex flex-col gap-y-8">
      ...
      <AddNotificationModal open={openAddNotificationModal} handleClose={handleCloseAddNotificationModal} mode={mode} notificationData={selectedData} />
      <DeleteConfModal
