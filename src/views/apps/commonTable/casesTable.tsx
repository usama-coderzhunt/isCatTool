...
const DebouncedInput = ({
  ...
  return <CustomTextField label={t('cases.table.search')} {...props} value={value} onChange={(e) => setValue(e.target.value)} />
}
...
const CasesTable: FC<CasesTableProps> = ({
  ...
  const handleCaseStatusConfirm = () => {
    ...
    editCase({ id: caseId, closed: newStatus }, {
      onSuccess: () => {
        toast.success('Case status changed successfully')
  ...
  return (
    <div className='flex flex-col gap-y-8'>
      ...
      <AddCasesModal
        ...
        mode={mode} caseData={selectedData}
