            ...
            <Fade in={open}>
                <Box sx={{ ...modalStyles, width: 450 }}>
                    <div className='flex gap-x-2 justify-between items-center mb-6'>
                        <Typography variant='h4'>{mode === 'create' ? t('caseTypes.addCaseTypeModal.title') : t('caseTypes.addCaseTypeModal.update')}</Typography>
                        <Button
                        ...
                        <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-6'>
                            ...
                            <div className='w-full flex justify-end'>
                                <Button
                                    ...
                                    type='submit'
                                >
                                    {mode === 'create' ? t('caseTypes.buttons.create') : t('caseTypes.buttons.update')}
                                </Button>
                            </div>
                        </form>
                    </Box>
