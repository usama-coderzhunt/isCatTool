...
import { useFetchTestimonialsPublic } from '@/services/useTestimonials'
...
const ServiceTestimonials = ({ serviceId }: { serviceId?: number }) => {
  ...
  const { data: TestimonialsData } = useFetchTestimonialsPublic(
    pagination.pageSize,
  ...
  return reviewsData?.length ? (
    <section
      className={classnames(
        'flex flex-col gap-8 plb-[100px] bg-backgroundDefault rounded-s-[3.75rem] rounded-e-[3.75rem]'
      )}
    >
      <div
      ...
      >
        ...
        <div className='is-full md:is-[70%] overflow-hidden'>
                    ...
                    <CardContent className='p-8 items-center mlb-auto h-full'>
                      <div className='flex flex-col gap-4 items-start h-full'>
                        ...
                        <div className='flex items-center gap-x-3 mt-auto'>
                          <Image width={32} height={32} src={item.avatarSrc} alt={item.name} className='rounded-full' />
          ...
          {/*) : (
        //   <Card elevation={8} className='flex items-center justify-center h-[100px]'>
        //     <CardContent>
        //       <Typography variant='h6' color='text.secondary' align='center'>
        //         {t('landingPage.customerReviews.noTestimonials')}
        //       </Typography>
        //     </CardContent>
        //   </Card>
         )}*/}
