        ...
        editLawyerClient(
            { id: Number(row.id), client_type: 'client' },
            {
                onSuccess: () => {
                    ...
                    toast.success('Lawyer Lead promoted to Client successfully')
                }
            }
        )
    }
                    ...
                    <div className='flex items-center justify-end gap-4 mb-4'>
                        {pathname?.includes('lawyer-clients') && hasPermissions(userPermissions, ['view_lawyerclient']) ? (
                            <Button
                                ...
                                variant='contained'
                                color='primary'
                                onClick={() => router.push(`/${currentLocale}/dashboards/lawyer-client/${row.id}`)}
                            >
                        ...
                        <div className='grid grid-cols-2 gap-x-8'>
                            ...
                            <div>
                                ...
                                <div className='flex items-center py-3 gap-x-4'>
                                    ...
                                    <Typography color='text.secondary' className='flex-1'>
                                        <span dir="ltr">
                                            {row.phone_number?.length ? row.phone_number : '-'}
                                        </span>
                                    </Typography>
                                </div>
