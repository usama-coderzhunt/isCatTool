...
const LawyerClientDetails = ({
  lawyerClientDetails,
  isLoading
}: {
  lawyerClientDetails: LawyerClientTypes
  isLoading: boolean
}) => {
              ...
              <div className='grid grid-cols-2 gap-x-8'>
                ...
                <div>
                  ...
                  <div className='flex items-center py-3 gap-x-4'>
                    ...
                    <Typography color='text.secondary' className='flex-1'>
                      {[
                        lawyerClientDetails?.first_name,
                        lawyerClientDetails?.middle_name,
                        lawyerClientDetails?.last_name
                      ]
                        .filter(Boolean)
                        .join(' ') || '-'}
                    </Typography>
                ...
                <div>
                  ...
                  <div className='flex items-center py-3 gap-x-4'>
                    ...
                    <Chip
                      label={
                        lawyerClientDetails?.is_active
                          ? t('lawyerClients.table.active')
                          : t('lawyerClients.table.inactive')
                      }
                  ...
                  <div className='flex items-center py-3 gap-x-4'>
                    ...
                    <Typography color='text.secondary' className='flex-1'>
                      {lawyerClientDetails?.created_at?.length
                        ? new Date(lawyerClientDetails.created_at)?.toDateString()
                        : '-'}
                    </Typography>
                  </div>
