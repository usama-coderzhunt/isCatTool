...
const ServiceCard: React.FC<ServicesCardProps> = ({ service }) => {
  ...
  return (
    ...
    >
      <Image
        className='!relative object-cover !h-[260px] !w-full'
        src={service?.image ? service?.image : '/images/pages/placeholder-image.webp'}
        alt={service?.name}
        fill
      />
      <CardContent>
        ...
        <div className='mt-5 w-full flex justify-start items-center'>
          <Button
            ...
            onClick={() => router.push(`/${currentLocale}/service-details/${service.slug}`)}
          >
