    ...
    <section id='home' className='overflow-hidden pbs-[75px] -mbs-[75px] relative'>
      ...
      <div className={classnames('pbs-[88px] overflow-hidden', frontCommonStyles.layoutSpacing)}>
        <div className='md:max-is-[650px] mbs-0 mbe-7 mli-auto text-center relative'>
          ...
          >
            {t('landingPage.heroSection.heading')}
          </Typography>
          <Typography className='font-bold text-white'>{t('landingPage.heroSection.subheading')}</Typography>
          <div className='flex mbs-6 items-center justify-center gap-4 flex-wrap'>
            <Button onClick={() => router.push(`/services`)} variant='contained' color='primary' size='large'>
              {t('landingPage.heroSection.buttons.explore')}
            </Button>
            <Button onClick={() => router.push(`/services`)} variant='contained' color='primary' size='large'>
              {t('landingPage.heroSection.buttons.demo')}{' '}
            </Button>
            <Button onClick={() => router.push(`/contact`)} variant='contained' color='primary' size='large'>
              {t('landingPage.heroSection.buttons.contact')}{' '}
            </Button>
          </div>
        </div>
      </div>
