...
const Contact = () => {
  ...
  const AllowedExtensions = ['.pdf', '.doc', '.docx', '.jpg', '.jpeg', '.png', '.txt', '.csv', '.xls', '.xlsx']
        ...
        <div className='lg:pis-[38px]'>
          <Grid container spacing={6}>
            ...
            <Grid size={{ xs: 12, md: 6, lg: 5 }}>
              <div
                className={`${classnames('border p-[10px] relative', styles.contactRadius)} bg-backgroundPaper`}
                style={{ direction: 'ltr' }}
              >
                <img
                ...
                <div className='flex justify-between flex-wrap gap-4 pli-6 pbs-4 pbe-[10px]'>
                  <div className='flex gap-3 item-center '>
                    <i className='tabler-mail h-full' />
                    <div>
                  ...
                  <div className='flex gap-3 item-center '>
                    <i className='tabler-phone h-full' />
              ...
              <Card>
                <CardContent>
                  ...
                  <form className='flex flex-col items-start gap-6' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    {/* Add ImageUploader before Recaptcha */}
                    <Controller
                      name='attachments'
                      control={control}
                      render={({ field: { onChange, value } }) => (
                        <ImageUploader
                          value={value}
                          onChange={onChange}
                          label={t('contact.formCard.fields.attachment')}
                          maxSize={5 * 1024 * 1024}
                          allowedExtensions={AllowedExtensions}
                          title={t('contact.formCard.fields.attachmentTitle')}
                          subTitle={t('contact.formCard.fields.attachmentSubTitle')}
                          required={false}
                        />
                      )}
                    />
                    ...
                    <Button
                      variant='contained'
                      type='submit'
                      disabled={loading || process.env.NEXT_PUBLIC_ENV === 'development' ? false : !recaptchaToken}
                    >
                      {loading
