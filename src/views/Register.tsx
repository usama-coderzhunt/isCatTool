          ...
          <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-6'>
            ...
            <div className='flex'>
              <FormControlLabel
                ...
                label={<span>{t('auth.register.agreeText')} </span>}
              />
              <div className='flex gap-1 leading-9 -ml-3'>
                <Link
                  className='text-primary'
                  href={getLocalizedUrl('/privacy-policy', locale as Locale)}
                  target='_blank'
                >
                ...
                <Link
                  className='text-primary'
                  href={getLocalizedUrl('/terms-of-service', locale as Locale)}
                  target='_blank'
                >
            ...
            <Button
              ...
              variant={'contained'}
              type='submit'
              disabled={!isAgreed || (process.env.NEXT_PUBLIC_ENV !== 'development' && !recaptchaToken)}
            >
