...
const Login = () => {
  ...
  const onSubmit: SubmitHandler<LoginInput> = data => {
    ...
    userLogin(data, {
      onSuccess: () => {
        toast.success(t('common.userLoggedInSuccess'))
        reset()
      }
    })
  }
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate autoComplete='off' className='flex flex-col gap-6'>
            ...
            <div className='flex justify-between items-center gap-x-3 gap-y-1 flex-wrap'>
              ...
              <Typography
                ...
                color='primary.main'
                component={Link}
                href={getLocalizedUrl(`/pages/auth/forgot-password`, locale as Locale)}
              >
            ...
            {isLoading ? (
              ...
              <Button
                ...
                variant='contained'
                type='submit'
                disabled={process.env.NEXT_PUBLIC_ENV === 'development' ? false : !recaptchaToken || isLoading}
              >
