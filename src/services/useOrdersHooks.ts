...
export const useOrdersHooks = () => {
    ...
    const getOrders = (pageSize?: number, page?: number, search?: string, ordering?: string) => {
        return useQuery({
            queryKey: ['orders', pageSize, page, search, ordering],
            queryFn: () => {
        ...
        return useQuery({
            ...
            queryFn: async () => {
                const response = await axiosInstance.get(
                    ...
                    { requiresAuth: true, requiredPermission: 'view_order' } as any
                )
