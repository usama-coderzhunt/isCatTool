...
const AddCasesModal: React.FC<AddCasesModalProps> = ({ open, handleClose, caseData, mode, selectedClients, clientId }) => {
                            ...
                            {!clientId && (
                                <div className='col-span-6'>
                                    <SearchableMultiSelect<CaseTypes>
                                        ...
                                        multiple={true}
                                        selectedOptionsList={mode === 'edit' ? clients : undefined}
                                        showAsterisk={true}
                                    />
                                </div>
                            )}
