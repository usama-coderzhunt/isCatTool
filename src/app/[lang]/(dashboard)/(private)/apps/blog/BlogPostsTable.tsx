...
import { exportBlogPostsToCSV } from '@/views/apps/commonTable/tableExport'
          ...
          <IconButton
            onClick={() => {
              const filteredData = posts.filter(post => {
                ...
                if (filters.category && post.category.toString() !== filters.category) {
                  return false
                }
              ...
              exportBlogPostsToCSV(filteredData)
            }}
