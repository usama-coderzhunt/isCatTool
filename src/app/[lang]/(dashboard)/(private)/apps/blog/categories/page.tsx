...
import { exportBlogCategoriesToCSV } from '@/views/apps/commonTable/tableExport'
...
const CategoriesPage = () => {
  ...
  const handleBulkDelete = async () => {
    await bulkDeleteCategories.mutateAsync(selectedCategories, {
      onSuccess: () => {
        const newTotalPages = Math.ceil((categoriesData?.count || 0) / pagination.pageSize)
        ...
        <Card>
          ...
          <Box sx={{ p: 3, pb: 0 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 3, gap: 2, flexWrap: 'wrap' }}>
              ...
              <IconButton
                onClick={() => exportBlogCategoriesToCSV(categoriesData?.results || [])}
