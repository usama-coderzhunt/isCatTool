            ...
            <div className="">
                <div className="">
                            ...
                            <Card className="">
                                <CardContent className="p-6">
                                    ...
                                    <Box className="mt-6 flex items-center justify-center gap-8">
                                        ...
                                        {/* Stripe Logo */}
                                        <img className="h-8 w-auto dark:hidden" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/stripe.svg" alt="Stripe" />
                                        <img className="hidden h-8 w-auto dark:flex" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/stripe-dark.svg" alt="Stripe" />
                    ...
                    <Typography variant="body2" color="text.secondary" className="mt-6 text-center lg:text-left">
                        Payment processed by <a href="#" className="text-primary-700 underline hover:no-underline">Paddle</a> for <a href="#" className="text-primary-700 underline hover:no-underline">Your Company</a>
                    </Typography>
                </div>
            </div>
        </div>
